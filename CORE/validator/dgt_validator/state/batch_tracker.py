...
from dgt_validator.execution.executor import InvalidTransactionObserver
from dgt_validator.journal.publisher import PendingBatchObserver
from dgt_validator.protobuf.client_batch_submit_pb2 \
