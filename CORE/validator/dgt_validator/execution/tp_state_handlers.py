...
from dgt_validator.protobuf import state_context_pb2
...
from dgt_validator.execution.context_manager import AuthorizationException
...
class TpStateSetHandler(Handler):
    def __init__(self, context_manager):
        ...
        Args:
            context_manager (dgt_validator.context_manager.
            ContextManager):
        """
        self._context_manager = context_manager
