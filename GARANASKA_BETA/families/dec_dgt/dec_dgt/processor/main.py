...
from dec_dgt.processor.handler import DecTransactionHandler
...
def main(args=None):
    ...
    try:
        ...
        log_config = get_log_config(filename="dec_log_config.toml")

        # If no toml, try loading yaml
        if log_config is None:
            log_config = get_log_config(filename="dec_log_config.yaml")
        ...
        if log_config is not None:
            ...
            log_configuration(
                log_dir=log_dir,
                name="dec-" + str(processor.zmq_id)[2:-1])
