...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='dgt_settings/protobuf/batch.proto',
  package='',
  syntax='proto3',
...
_BATCH.fields_by_name['transactions'].message_type = dgt__settings_dot_protobuf_dot_transaction__pb2._TRANSACTION
...
BatchHeader = _reflection.GeneratedProtocolMessageType('BatchHeader', (_message.Message,), dict(
  ...
  __module__ = 'dgt_settings.protobuf.batch_pb2'
