...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='dgt_settings/protobuf/transaction_receipt.proto',
  package='',
  syntax='proto3',
...
_TRANSACTIONRECEIPT.fields_by_name['events'].message_type = dgt__settings_dot_protobuf_dot_events__pb2._EVENT
...
TransactionReceipt = _reflection.GeneratedProtocolMessageType('TransactionReceipt', (_message.Message,), dict(
  ...
  __module__ = 'dgt_settings.protobuf.transaction_receipt_pb2'
