...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='dgt_settings/protobuf/block.proto',
  package='',
  syntax='proto3',
...
_BLOCK.fields_by_name['batches'].message_type = dgt__settings_dot_protobuf_dot_batch__pb2._BATCH
...
BlockHeader = _reflection.GeneratedProtocolMessageType('BlockHeader', (_message.Message,), dict(
  ...
  __module__ = 'dgt_settings.protobuf.block_pb2'
