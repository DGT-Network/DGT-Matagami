...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='dgt_settings/protobuf/state_context.proto',
  package='',
  syntax='proto3',
...
_TPEVENTADDREQUEST.fields_by_name['event'].message_type = dgt__settings_dot_protobuf_dot_events__pb2._EVENT
...
TpStateEntry = _reflection.GeneratedProtocolMessageType('TpStateEntry', (_message.Message,), dict(
  ...
  __module__ = 'dgt_settings.protobuf.state_context_pb2'
