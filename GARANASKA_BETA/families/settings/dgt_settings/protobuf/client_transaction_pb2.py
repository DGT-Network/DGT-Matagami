...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='dgt_settings/protobuf/client_transaction.proto',
  package='',
  syntax='proto3',
  ...
  ,
  dependencies=[dgt__settings_dot_protobuf_dot_transaction__pb2.DESCRIPTOR,dgt__settings_dot_protobuf_dot_client__list__control__pb2.DESCRIPTOR,])
...
_CLIENTTRANSACTIONLISTREQUEST.fields_by_name['paging'].message_type = dgt__settings_dot_protobuf_dot_client__list__control__pb2._CLIENTPAGINGCONTROLS
_CLIENTTRANSACTIONLISTREQUEST.fields_by_name['sorting'].message_type = dgt__settings_dot_protobuf_dot_client__list__control__pb2._CLIENTSORTCONTROLS
_CLIENTTRANSACTIONLISTRESPONSE.fields_by_name['status'].enum_type = _CLIENTTRANSACTIONLISTRESPONSE_STATUS
_CLIENTTRANSACTIONLISTRESPONSE.fields_by_name['transactions'].message_type = dgt__settings_dot_protobuf_dot_transaction__pb2._TRANSACTION
_CLIENTTRANSACTIONLISTRESPONSE.fields_by_name['paging'].message_type = dgt__settings_dot_protobuf_dot_client__list__control__pb2._CLIENTPAGINGRESPONSE
...
_CLIENTTRANSACTIONGETRESPONSE.fields_by_name['transaction'].message_type = dgt__settings_dot_protobuf_dot_transaction__pb2._TRANSACTION
...
ClientTransactionListRequest = _reflection.GeneratedProtocolMessageType('ClientTransactionListRequest', (_message.Message,), dict(
  ...
  __module__ = 'dgt_settings.protobuf.client_transaction_pb2'
