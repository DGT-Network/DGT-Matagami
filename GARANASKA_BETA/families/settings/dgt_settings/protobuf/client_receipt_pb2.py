...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='dgt_settings/protobuf/client_receipt.proto',
  package='',
  syntax='proto3',
  ...
  ,
  dependencies=[dgt__settings_dot_protobuf_dot_transaction__receipt__pb2.DESCRIPTOR,])
...
_CLIENTRECEIPTGETRESPONSE.fields_by_name['receipts'].message_type = dgt__settings_dot_protobuf_dot_transaction__receipt__pb2._TRANSACTIONRECEIPT
...
ClientReceiptGetRequest = _reflection.GeneratedProtocolMessageType('ClientReceiptGetRequest', (_message.Message,), dict(
  ...
  __module__ = 'dgt_settings.protobuf.client_receipt_pb2'
