...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='dgt_settings/protobuf/client_event.proto',
  package='',
  syntax='proto3',
  ...
  ,
  dependencies=[dgt__settings_dot_protobuf_dot_events__pb2.DESCRIPTOR,])
...
_CLIENTEVENTSSUBSCRIBEREQUEST.fields_by_name['subscriptions'].message_type = dgt__settings_dot_protobuf_dot_events__pb2._EVENTSUBSCRIPTION
...
_CLIENTEVENTSGETREQUEST.fields_by_name['subscriptions'].message_type = dgt__settings_dot_protobuf_dot_events__pb2._EVENTSUBSCRIPTION
_CLIENTEVENTSGETRESPONSE.fields_by_name['status'].enum_type = _CLIENTEVENTSGETRESPONSE_STATUS
_CLIENTEVENTSGETRESPONSE.fields_by_name['events'].message_type = dgt__settings_dot_protobuf_dot_events__pb2._EVENT
...
ClientEventsSubscribeRequest = _reflection.GeneratedProtocolMessageType('ClientEventsSubscribeRequest', (_message.Message,), dict(
  ...
  __module__ = 'dgt_settings.protobuf.client_event_pb2'
