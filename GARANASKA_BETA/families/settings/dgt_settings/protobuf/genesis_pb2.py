...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='dgt_settings/protobuf/genesis.proto',
  package='',
  syntax='proto3',
...
_GENESISDATA.fields_by_name['batches'].message_type = dgt__settings_dot_protobuf_dot_batch__pb2._BATCH
...
GenesisData = _reflection.GeneratedProtocolMessageType('GenesisData', (_message.Message,), dict(
  ...
  __module__ = 'dgt_settings.protobuf.genesis_pb2'
