...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='dgt_settings/protobuf/client_batch_submit.proto',
  package='',
  syntax='proto3',
  ...
  ,
  dependencies=[dgt__settings_dot_protobuf_dot_batch__pb2.DESCRIPTOR,])
...
_CLIENTBATCHSUBMITREQUEST.fields_by_name['batches'].message_type = dgt__settings_dot_protobuf_dot_batch__pb2._BATCH
...
ClientBatchStatus = _reflection.GeneratedProtocolMessageType('ClientBatchStatus', (_message.Message,), dict(
  ...
  InvalidTransaction = _reflection.GeneratedProtocolMessageType('InvalidTransaction', (_message.Message,), dict(
    ...
    __module__ = 'dgt_settings.protobuf.client_batch_submit_pb2'
