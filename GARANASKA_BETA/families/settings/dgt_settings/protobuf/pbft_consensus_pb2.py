...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='dgt_settings/protobuf/pbft_consensus.proto',
  package='',
  syntax='proto3',
  ...
  ,
  dependencies=[dgt__settings_dot_protobuf_dot_consensus__pb2.DESCRIPTOR,])
...
_PBFTNEWVIEW.fields_by_name['view_changes'].message_type = dgt__settings_dot_protobuf_dot_consensus__pb2._CONSENSUSPEERMESSAGENEW
_PBFTSEAL.fields_by_name['block'].message_type = _PBFTBLOCKMESSAGE
_PBFTSEAL.fields_by_name['commit_votes'].message_type = dgt__settings_dot_protobuf_dot_consensus__pb2._CONSENSUSPEERMESSAGENEW
...
PbftBlockMessage = _reflection.GeneratedProtocolMessageType('PbftBlockMessage', (_message.Message,), dict(
  ...
  __module__ = 'dgt_settings.protobuf.pbft_consensus_pb2'
