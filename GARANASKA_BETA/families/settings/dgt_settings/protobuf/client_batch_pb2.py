...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='dgt_settings/protobuf/client_batch.proto',
  package='',
  syntax='proto3',
  ...
  ,
  dependencies=[dgt__settings_dot_protobuf_dot_batch__pb2.DESCRIPTOR,dgt__settings_dot_protobuf_dot_client__list__control__pb2.DESCRIPTOR,])
...
_CLIENTBATCHLISTREQUEST.fields_by_name['paging'].message_type = dgt__settings_dot_protobuf_dot_client__list__control__pb2._CLIENTPAGINGCONTROLS
_CLIENTBATCHLISTREQUEST.fields_by_name['sorting'].message_type = dgt__settings_dot_protobuf_dot_client__list__control__pb2._CLIENTSORTCONTROLS
_CLIENTBATCHLISTRESPONSE.fields_by_name['status'].enum_type = _CLIENTBATCHLISTRESPONSE_STATUS
_CLIENTBATCHLISTRESPONSE.fields_by_name['batches'].message_type = dgt__settings_dot_protobuf_dot_batch__pb2._BATCH
_CLIENTBATCHLISTRESPONSE.fields_by_name['paging'].message_type = dgt__settings_dot_protobuf_dot_client__list__control__pb2._CLIENTPAGINGRESPONSE
...
_CLIENTBATCHGETRESPONSE.fields_by_name['batch'].message_type = dgt__settings_dot_protobuf_dot_batch__pb2._BATCH
...
ClientBatchListRequest = _reflection.GeneratedProtocolMessageType('ClientBatchListRequest', (_message.Message,), dict(
  ...
  __module__ = 'dgt_settings.protobuf.client_batch_pb2'
