...
from deth.processor.handler import DETH_ADDRESS_PREFIX,FAMILY_NAME,FAMILY_VER
from deth.processor.handler import make_deth_address


class DethMessageFactory:
    def __init__(self, signer=None):
        self._factory = MessageFactory(
            family_name=FAMILY_NAME,
            family_version=FAMILY_VER,
            namespace=DETH_ADDRESS_PREFIX,
            signer=signer)
    ...
    def _create_txn(self, txn_function, verb, name, value):
        ...
        addresses = [make_deth_address(name)]
    ...
    def create_get_response(self, name, value):
        address = make_deth_address(name)
