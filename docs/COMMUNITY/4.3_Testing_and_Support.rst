...
•	To track errors, we use a bug tracking system, which can be accessed by any project participant (`see 4.2.1`_). For this, you need to contact `partnership@dgt.world`_. 
...
Community members will be happy to hear any request for details on the issues described and are ready to provide the necessary clarifications and demonstrations. 
 ...
 .. _see 4.2.1: 4.2_DGT_Development_Contributing.html#development-role-models